 ...
 *
 */
class ValSamonte_ScheduledProduct_Model_Attribute_Backend_Datetime extends Mage_Eav_Model_Entity_Attribute_Backend_Datetime
{
  /**
   ...
   * @var string
   */
  const ATTRIBUTE_ACTIVATION_DATE = 'valsamonte_activation_date';
  /**
   * Expiry date attribute code
   *
   * @var string
   */
  const ATTRIBUTE_EXPIRY_DATE = 'valsamonte_expiry_date';
  /**
   ...
   * @return ValSamonte_ScheduledProduct_Model_Attribute_Backend_Datetime
   */
